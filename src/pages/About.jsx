function About() {
 return (
  <div className="prose lg:prose-xl">
   ...
   <p>
    Welcome to our e-commerce platform! We are dedicated to providing the best
    online shopping experience. With a wide range of products, competitive
    pricing, and exceptional customer service, we strive to make your shopping
    journey as seamless as possible.
   </p>
   <p>
    Our mission is to connect customers with products they love, from trusted
    sellers around the world. Whether you're looking for the latest gadgets,
   ...
   <blockquote>
    "E-commerce is not the cherry on the cake, it's the new cake." — Jean-Paul
    Ago
   </blockquote>
